...
class CalificacionAdmin(admin.ModelAdmin):
    ...
    list_display = ['calid','monto', 'factor', 'periodo', 'instrumento', 'estado', 'fecha_creacion', 'fecha_modificacion', 'usuario_id_usuario', 'factor_val_id_factor' ]
...
class UsuarioAdmin(admin.ModelAdmin):
    ...
    list_display = ['nombre', 'email', 'rol_id', 'activo']

class RolAdmin(admin.ModelAdmin):

    list_display = ['rol', 'permiso', 'descripcion_rol' ]

class BusquedaAdmin(admin.ModelAdmin):

    list_display = ['id_busqueda', 'criterios_busqueda', 'usuario_id_usuario']
...
class AuditoriaAdmin(admin.ModelAdmin):
    ...
    list_display = ['id_Auditoria', 'accion', 'Tabla', 'Cambios', 'Fecha', 'ip', 'Firma_Digital', 'usuario_id_usuario']
...
admin.site.register(RolPermiso, Rol_permisoAdmin)